...
namespace homehelp.Events
{
    ...
    {
        private GameEventString _gameEventString;
        public void OnEnable()
        {
            _gameEventString = (GameEventString)target;
            _gameEventString.value = "null";
        }
        public override void OnInspectorGUI()
        {
            ...
            {
                CreateInterface(_gameEventString.name);
            }
            ...
            GUILayout.Label("Value: " + _gameEventString.value, boldText);
            
            var so = new SerializedObject(_gameEventString);
            ...
            if (GUILayout.Button("Raise"))
                _gameEventString.Raise(_gameEventString.simulateValue);

            GUILayout.Space(10);
            GUILayout.Label("String", rightAlignment);
